...
All keyword data is loaded at runtime from the entity_intel DB table via
refresh_entity_intel(). Pattern lists start empty and are populated at startup.
"""
import logging
import re
...
# Pre-compiled patterns for keyword matching — populated by refresh_entity_intel()
...
# Alias patterns — populated by refresh_entity_intel()

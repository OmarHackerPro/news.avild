"""Create clusters and cluster_articles tables

Revision ID: c3d4e5f6a7b8
Revises: b2c3d4e5f6a7
Create Date: 2026-03-13 12:03:00.000000
"""
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("state", sa.String(50), nullable=False, server_default="new", index=True),

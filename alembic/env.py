...
import app.db.models.cluster            # noqa: F401 — registers Cluster/ClusterArticle with Base.metadata

config = context.config

# Override the URL from .env so alembic.ini default is never used directly
